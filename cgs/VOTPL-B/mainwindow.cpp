...
void MainWindow::Gviewtop()
{

    int value1=data4.toInt();




    scene1 = new QGraphicsScene();
    scene1->setSceneRect(0,0,100,100);

         scene1->clear();

        QGraphicsPixmapItem *top = scene1->addPixmap( QPixmap(":/image/top_view_agv.png").scaled(150, 150) );
       top->setPos(-10,-10);

       QPointF offset = top->sceneBoundingRect().center();
     ...
     QGraphicsPixmapItem *combos = scene1->addPixmap( QPixmap(":/image/bomoss.png").scaled(240, 240) );
    combos->setPos(-95,-70);
...
void MainWindow::Gviewside()
{
    ...
    scene2->setSceneRect(0,0,100,100);

     int value1=data3.toInt();
    scene2->clear();


    QGraphicsPixmapItem *side = scene2->addPixmap( QPixmap(":/image/side_view_agv.png").scaled(170, 170) );
    side->setPos(-40,-30);

    QPointF offset1 = side->sceneBoundingRect().center();
    QTransform transform1;
    transform1.translate(offset1.x() ,offset1.y());
    transform1.rotate(value1);
    transform1.translate(-offset1.x(),-offset1.y());
    side->setTransform(transform1);


    QGraphicsPixmapItem *combos1 = scene2->addPixmap( QPixmap(":/image/comboss1.png").scaled(220, 220) );
    combos1->setPos(-60,-60);
...
void MainWindow::Gviewback()
{


    scene3 = new QGraphicsScene();
    scene3->setSceneRect(0,0,100,100);

    int value1=data2.toInt();
    scene3->clear();

    QGraphicsPixmapItem *back = scene3->addPixmap( QPixmap(":/image/back_view_agv.png").scaled(170, 170) );
   back->setPos(-35,-40);

   QPointF offset2 = back->sceneBoundingRect().center();
   QTransform transform2;
   transform2.translate(offset2.x() ,offset2.y());
   transform2.rotate(value1);
   transform2.translate(-offset2.x(),-offset2.y());
   back->setTransform(transform2);

   QGraphicsPixmapItem *combos2 = scene3->addPixmap( QPixmap(":/image/comboss1.png").scaled(220, 220) );
     combos2->setPos(-65,-60);
...
void MainWindow::on_semi_automatic_clicked()
{
